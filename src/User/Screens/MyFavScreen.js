...
let page  = this.state.page +1
  ...
  componentDidMount = async () => {
    ...
    this.setState({ uid: value,session_id:session_id,lat:lat,long:long })
                  ...
                  <TouchableWithoutFeedback >
                    <View style={{ flexDirection: 'column', width: "55%", paddingVertical: 5 }}>
                      ...
                      {/* <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={{ fontSize: 11, color: '#c2612d', paddingHorizontal: 5 }}>
                        {Math.floor(getDistance({latitude:this.state.lat,longitude:this.state.long}, {
