...
await fetch('https://www.markupdesigns.org/paypa/api/paymentWithMobile', {
 ...
 <TouchableOpacity 
   ...
   {""+ this.state.rbal}
      ...
      {this.state.expdate !==""?<Text style ={{color:'white', fontFamily:'Roboto-Light',fontSize:15,textAlign:'center'}}>
         Your limit balance will expire on<Text style ={{color:'#e46c0b', fontFamily:'Roboto-Light',fontSize:15,textAlign:'center'}}>{this.state.expireDate}{Moment(this.state.expdate).format('DD MMMM, YYYY')}</Text></Text>:null}
