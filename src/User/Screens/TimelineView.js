...
<Text></Text>
  ...
  <List>
              ...
              <ListItem>
{navigation.getParam('week')==='null-null'?<Text>Closed</Text>:<Text>{navigation.getParam('week')}</Text>}
              </ListItem>
              ...
              <ListItem>
              {navigation.getParam('fri')==='null-null'?<Text>Closed</Text>:<Text>{navigation.getParam('fri')}</Text>}
              </ListItem>
              <ListItem itemDivider>
                <Text>Saturday</Text>
              </ListItem>                    
              <ListItem>
              {navigation.getParam('sat')==='null-null'?<Text>Closed</Text>:<Text>{navigation.getParam('sat')}</Text>}
              </ListItem>
              ...
              <ListItem>
              {navigation.getParam('sun')==='null-null'?<Text>Closed</Text>:<Text>{navigation.getParam('sun')}</Text>}
              </ListItem>
            </List>
