...
PaymentHistory = async()=>{
  ...
  await fetch('https://www.markupdesigns.org/paypa/api/recentPaymentHistory', {
   ...
   await this.setState({uid:value,mymobile:mobile,isVisible:false},()=> this.PaymentHistory())
          ...
          .then((responseJson) => {
           this.setState({loading:false})
            ...
            if(responseJson.status ==="Failure"){
             ...
             let total = bal + rbal;
              this.setState({loading:false,myBalance:total.toFixed(2)})
   ...
   <ActivityIndicator
    ...
    return (
      ...
      <StatusBar barStyle="light-content" backgroundColor="#1c4478"/>
          ...
          <StatusBar barStyle="light-content" backgroundColor="#1c4478"/>
                  <Item>
                      <Input placeholder="Enter Cell Number To Transfer PayPa Bucks To" value = {this.state.mobile}   onChangeText={mobile => this.setState({mobile})}
