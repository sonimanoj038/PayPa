...
import { Container, Radio,Right,Text, Left,Input,Item ,Button,ActionSheet, Footer,Header,Body,Title, Content,Textarea} from 'native-base';
...
componentDidMount = async() => {
  ...
  this.setState({userid:value,imagesUpload:finalImg,timeline_id:timeline_id,session_id:session_id})
}
