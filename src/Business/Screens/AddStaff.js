...
import {
  ...
  View,
  TouchableOpacity,
  StatusBar, Image, Platform,Alert,
...
export default class AddStaff extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    this.setState({session_id:session_id,token:token})
    ...
    checkSession(this.state.session_id).then(result=>{
      ...
      if(result){
        ...
        if (this.validateInput()) {
           fetch('https://www.markupdesigns.org/paypa/api/addStaff', {
            method: 'POST',
            headers: {
        ...
        <ScrollView style={{}} showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}>
          <Content>
            ...
            <Item regular style={styles.InputItem} >
              ...
              <Input placeholder='Cell Number' placeholderTextColor="#797b7d"
            ...
            <Mytext></Mytext>
            <Item regular style={styles.InputItem} >
              <Input placeholder='Confirm Cell Number' placeholderTextColor="#797b7d"
