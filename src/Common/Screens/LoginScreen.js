...
<View style = {{flexDirection:'row'}}>
  ...
  <TouchableOpacity onPress ={()=> navigate('Signup',{type:this.state.type,msg:this.state.status})}><Mytext style = {{color:'#dce0e6',fontSize:13,padding:2,paddingHorizontal:3}}>Sign Up Now</Mytext></TouchableOpacity>
</View>
