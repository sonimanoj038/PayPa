...
await fetch('https://www.markupdesigns.org/paypa/api/logout', {
 ...
 <Container >
    <Header  style={{backgroundColor:'#1c4478'}}>
        ...
        <ListItem  style = {{backgroundColor:'#f2dece',padding:0}} button onPress ={()=> this.props.navigation.navigate('ShowStaff')}>
           ...
           <Text>
            ...
            <Button block  style = {{width:'95%',justifyContent:'center',alignItems:'center',alignSelf:'center', 
            backgroundColor:'#e46c0b'}}  onPress ={()=> this.props.navigation.navigate('LogoutScreen')}>
